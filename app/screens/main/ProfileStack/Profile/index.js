...
class ProfileScreen extends Component {
  ...
  componentWillMount() {
    // var CLOUD_NAME = "dzekhyqfl"; 
    // var API_KEY = "934474875918297";
    // var API_SECRET = "dFJkA5oNrPg2kVu-jdKuXK5l28A";
    // var PRESET_NAME = "ng2xzeqd";
    // // RNCloudinary.config(CLOUD_NAME, API_KEY, API_SECRET, PRESET_NAME);

    // console.log("my test start________________")
    
    // // var filePath = {uri: 'https://facebook.github.io/react-native/docs/assets/favicon.png'};
    // // RNCloudinary.uploadImage(filePath).then(data => {
    // //   console.log("upload success_______________________________________", data);
    // // })
    // // .catch(err => {
    // //   console.log("upload error_______________________________________", err);
    // // });
    
    // console.log("my test end________________")
  }
            ...
            renderHeader={() => 
              <View style={{ height: WINDOW_HEIGHT * 0.6, backgroundColor: 'transparent' }}>
                <View style={{ position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, backgroundColor: '#efefef' }} >
                  ...
                  />
                  {/* <Image source={( this.state.photoList && this.state.photoList.length > 0 && this.state.avatarNum > 0 && this.state.photoList[this.state.avatarNum - 1].isPrivate === true ) ? {uri: this.state.photoList[this.state.avatarNum - 1].url} : Images.profileAvatar} style={ styles.photoContainer } /> */}
                </View>
